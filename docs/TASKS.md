...
> Единственное не-авто-проверенное: пиксельный/клик-прогон в реальном браузере (Playwright MCP был
> недоступен) — SPA живёт на `localhost:8000`, рантайм покрыт jsdom-тестами.
>
